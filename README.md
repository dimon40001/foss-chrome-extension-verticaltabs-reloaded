...
This is a fork of original Vertical Tabs extension which worked well in the past but didn't receive
updates after version 2.0.2 and at some point became incompatible with the current version of Google Chrome.
